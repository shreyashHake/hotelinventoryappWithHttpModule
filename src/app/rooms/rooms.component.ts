...
export class RoomsComponent implements OnInit, AfterViewInit, AfterViewChecked, OnDestroy {
  ...
  ngAfterViewChecked() {
    /** In development mode the code is checked twice, and this ngAfterViewChecked executes after 1 out of 2 lifecycle. */
  }
  ...
  ngOnInit(): void {
    ...
    /** this will make 'n' calls if the container is loaded 'n' times
    ...
    */
    ...
    // this will make only 1 calls if the container is loaded 'n' times (it catchess the first request itself)
